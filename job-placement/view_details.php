                ...
                <section class="dashboard-header">
                    <div class="container-fluid">
        				<div class="row">
                            ...
                            ?>
                                <h4 class="mb-4"> <i class="icon-bill"></i> <span class="text-uppercase">Job Placement Information for <?php echo "$student_name"; ?></span> </h4>
                                <div class="row">
                					<div class="col-md-10 col-12 mx-auto row">
                						<div class="col-md-2">
                							<p class="student-text text-center mt-5"> <img src="<?php echo $media_folder/$photos; ?>" alt="Smiley face" class="img-fluadmission_number img-thumbnail"></p>
                						</div>
                						<div class="col-md-6 p-3 pro-text">
                							<p class="student-text" style="font-size: 26px;"><?php echo $student_name ?></p>
                						</div>
                						<div class="col-md-4 pro-text p-3">
