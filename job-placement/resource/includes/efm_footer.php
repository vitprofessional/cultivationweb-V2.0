	<!-- Page Footer-->
          <footer class="main-footer">
            <div class="container-fluid">
              <div class="row">
                <div class="col-sm-6">
                  <p>Copyrights &copy; <?php  echo $website_name; ?> - <?php echo date("Y");?></p>
                </div>
                <div class="col-sm-6 text-right">
                  <p>Design by <a href="<?php echo $creator_fblink; ?>" target="_blank" class="external"><?php echo $site_creator; ?></a></p>
