...
<head>
    ...
    <link rel="apple-touch-icon" href="{{ asset('public/educavo/apple-touch-icon.html') }}">
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('public/educavo/assets/images/fav.png') }}">

    <link rel="stylesheet" type="text/css" href="{{ asset('public/educavo/assets/css/bootstrap.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('public/educavo/assets/css/font-awesome.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('public/educavo/assets/css/animate.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('public/educavo/assets/css/owl.carousel.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('public/educavo/assets/css/slick.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('public/educavo/assets/css/off-canvas.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('public/educavo/assets/fonts/linea-fonts.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('public/educavo/assets/fonts/flaticon.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('public/educavo/assets/css/magnific-popup.css') }}">
    <link rel="stylesheet" href="{{ asset('public/educavo/assets/css/rsmenu-main.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('public/educavo/assets/css/rs-spacing.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('public/educavo/style.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('public/educavo/assets/css/responsive.css') }}">
...
<body class="home-style2">
                ...
                @foreach($sliderItems as $slide)
                    @php
                        $slideImage = !empty($slide->avatar)
                            ...
                            : asset('public/educavo/assets/images/slider/h2-1.jpg');
                        $slideHeading = !empty($slide->headLine) ? $slide->headLine : 'World Leading University';
                        $slideDetail = !empty($slide->detail) ? $slide->detail : (!empty($config?->instituteName) ? $config->instituteName : 'Educavo University');
                    @endphp
            ...
            <div class="row no-gutter">
                <div class="col-lg-3 col-md-6">
                    <div class="service-item overly1">
                        <img src="{{ asset('public/educavo/assets/images/services/1.jpg') }}" alt="">
                        <div class="content-part">
                            <img src="{{ asset('public/educavo/assets/images/services/icons/1.png') }}" alt="">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="service-item overly2">
                        <img src="{{ asset('public/educavo/assets/images/services/1.jpg') }}" alt="">
                        <div class="content-part">
                            <img src="{{ asset('public/educavo/assets/images/services/icons/2.png') }}" alt="">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="service-item overly3">
                        <img src="{{ asset('public/educavo/assets/images/services/1.jpg') }}" alt="">
                        <div class="content-part">
                            <img src="{{ asset('public/educavo/assets/images/services/icons/3.png') }}" alt="">
                        ...
                        <div class="row grid-area">
                            <div class="col-md-6 sm-mb-30">
                                <div class="image-grid">
                                    <img src="{{ $resolveGalleryImage($firstImage, 'public/educavo/assets/images/about/style2/grid1.jpg') }}" alt="">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="image-grid">
                                    <img src="{{ $resolveGalleryImage($secondImage, 'public/educavo/assets/images/about/style2/grid2.jpg') }}" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row y-middle">
                    ...
                    <div class="col-lg-4 col-md-6 mb-30">
                        <div class="degree-wrap">
                            <img src="{{ $resolveGalleryImage($thirdImage, 'public/educavo/assets/images/degrees/1.jpg') }}" alt="">
                    ...
                    <div class="col-lg-4 col-md-6 mb-30">
                        <div class="degree-wrap">
                            <img src="{{ $resolveGalleryImage($fourthImage, 'public/educavo/assets/images/degrees/2.jpg') }}" alt="">
                    ...
                    <div class="col-lg-4 col-md-6 mb-30">
                        <div class="degree-wrap">
                            <img src="{{ asset('public/educavo/assets/images/degrees/3.jpg') }}" alt="">
                    ...
                    <div class="col-lg-4 col-md-6 mb-30">
                        <div class="degree-wrap">
                            <img src="{{ asset('public/educavo/assets/images/degrees/4.jpg') }}" alt="">
                    ...
                    <div class="col-lg-4 col-md-6 mb-30">
                        <div class="degree-wrap">
                            <img src="{{ asset('public/educavo/assets/images/degrees/5.jpg') }}" alt="">
                    ...
                    <div class="gallery-grid">
                        ...
                        @empty
                            @for($i = 0; $i < 6; $i++)
                                <button type="button"
                                        class="gallery-tile gallery-modal-trigger"
                                        data-image="{{ asset('public/educavo/assets/images/blog/style2/1.jpg') }}"
                                        data-title="Gallery Image"
                                        data-description="Memorable moment captured from our campus activities."
                                        data-date=""
                                        aria-label="Open photo details">
                                    <img src="{{ asset('public/educavo/assets/images/blog/style2/1.jpg') }}" alt="Gallery image">
                                    <span class="gallery-shade"></span>
                                    <span class="gallery-plus"><i class="fa fa-search-plus" aria-hidden="true"></i></span>
    ...
    <script src="{{ asset('public/educavo/assets/js/skill.bars.jquery.js') }}"></script>
    <script src="{{ asset('public/educavo/assets/js/jquery.counterup.min.js') }}"></script>
    <script src="{{ asset('public/educavo/assets/js/waypoints.min.js') }}"></script>
    <script src="{{ asset('public/educavo/assets/js/jquery.mb.YTPlayer.min.js') }}"></script>
    <script src="{{ asset('public/educavo/assets/js/jquery.magnific-popup.min.js') }}"></script>
    <script src="{{ asset('public/educavo/assets/js/plugins.js') }}"></script>
    <script src="{{ asset('public/educavo/assets/js/contact.form.js') }}"></script>
