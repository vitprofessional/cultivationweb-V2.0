    ...
    <div class="academic-page-shell">
        <div class="academic-page-head">
            <div>
                ...
                <h2>Exam Routine Archive</h2>
                <p>Filter and access published exam routines with view, print, and PDF actions.</p>
            </div>
            <span class="academic-count"><i class="fa fa-clipboard"></i> {{ $rows->count() }} {{ $rows->count() === 1 ? 'Routine' : 'Routines' }}</span>
        </div>
        ...
        <div class="academic-table-wrap">
            <form method="GET" class="academic-filter row g-2 mb-3">
                ...
                <div class="col-12 col-md-3 d-flex gap-2">
                    ...
                    <a href="{{ route('newExamSchedule') }}" class="btn btn-academic btn-academic-secondary btn-sm">Reset</a>
                </div>
            </form>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="routine-actions">
                                            <a href="{{ route('examRoutine.view', ['id' => $data->id]) }}" class="btn btn-academic btn-academic-info btn-sm">View</a>
                                            <a href="{{ route('examRoutine.print', ['id' => $data->id]) }}" target="_blank" class="btn btn-academic btn-academic-primary btn-sm">Print</a>
                                            <a href="{{ route('examRoutine.download', ['id' => $data->id]) }}" class="btn btn-academic btn-academic-danger btn-sm">PDF</a>
                                        </div>
                                    </td>
                                </tr>
                            @endforeach
            ...
            @else
                <div class="academic-empty">No exam routine records found for the selected filters.</div>
            @endif
        </div>
    </div>
</section>
