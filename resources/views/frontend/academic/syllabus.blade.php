    ...
    <div class="academic-page-shell">
        <div class="academic-page-head">
            <div>
                ...
                <h2>Syllabus Library</h2>
                <p>Browse published syllabus files by class, department, and session.</p>
            </div>
            <span class="academic-count"><i class="fa fa-book"></i> {{ $rows->count() }} {{ $rows->count() === 1 ? 'Record' : 'Records' }}</span>
        </div>
                            ...
                            @foreach($rows as $data)
                                <tr>
                                    ...
                                    @php
                                        ...
                                        $fileUrl = config('app.url').'/public/upload/image/cultivation/syllabus/'.rawurlencode(basename($attachment));
                                    @endphp
                                    <td>
                                    ...
                                    <td>
                                        @if(!empty($attachment))
                                            <a class="academic-view-btn" data-fancybox data-type="iframe" href="{{ $fileUrl }}" target="_blank" title="View Syllabus">
                                                <i class="fa fa-eye"></i>
                                            </a>
                                        @else
        ...
        @else
            <div class="academic-empty">No syllabus records found.</div>
        @endif
    </div>
</section>
@endsection